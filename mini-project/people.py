...
def create(person):
    ...
    :return: 201 on success, 406 on person existes
    """
    ...
    # Otherwise, nope, person existes already
    else:
...
def update(person_id, person):
    ...
    Throws an erro if a person with the name we want to update to
    ...
    # Otherwise go ahead and update
        ...
        update.person_id = update.person.person_id
